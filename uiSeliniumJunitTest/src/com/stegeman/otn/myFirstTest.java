...
public class myFirstTest {
    ...
    public void setUp() throws Exception {
       selenium =
                new DefaultSelenium("localhost", 4444, "*firefox C:\\Users\\gshaik\\AppData\\Local\\Mozilla Firefox\\firefox.exe", "http://businessi3.socalgas.com/");
        //        selenium =
    ...
    public void testMyFirst() throws Exception {
        ...
        //selenium.open("/security/signin.fcc");
...
//        selenium.click("id=not-you");
        ...
        selenium.waitForPageToLoad("30000");
        selenium.click("pt1:pli1:baNickName\\::content");
